...
public class ScheduleController {
	 ...
	 * fixedRate : 이전 작업 시작 시점을 기준으로 일정 간경으로 메서드 수행
	 * 
	 * */
//	@Scheduled(fixedDelay = 5000)	// 작업 종류 후 5초의 지연시간을 둔뒤 다시 실행
...
//	@Scheduled(fixedRate = 5000)
	 ...
	 *     L : 마지막 (매월 말일을 지정할때 사용)
	 *     W : 가장 가까운 평일(15W)
	 *     # : N번재 요일
	 *     
	 *     매일 오전 1시에 어떤 작업을 실횅하게 하고싶다.
	 *     0 0 1 * * *
	 *     
	 *     매 시간 30분
	 *     0 30 * * * * 
...
//	@Scheduled(cron = "0,30 * * * * *")	// 매분 0초마다 작업을 수행
