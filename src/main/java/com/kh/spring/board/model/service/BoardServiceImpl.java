...
public class BoardServiceImpl implements BoardService {
	...
	public int insertBoard(Board b, List<BoardImg> imgList) {
		...
		// 데이터 전처리 
		// - 게시글 내용 : XSS핸들링 및 개행 문자 처리
		// - 게시글 제목 : XSS핸들링 및 개행 문자 처리
		...
		//게시글 저장
		// - mybatis의 selectKey기능을 이용하여 boardNo값을 b객체에 할당
